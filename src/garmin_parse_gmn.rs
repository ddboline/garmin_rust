...
impl GarminParseGmn {
    pub fn new(
        ...
        let (lap_list, point_list, sport) = parse_xml(filename).expect("Failed to parse xml");
...
fn parse_xml(filename: &str) -> Result<(Vec<GarminLap>, Vec<GarminPoint>, Option<String>), Error> {
